var Shapes = (function () {
    ...
    var Point = (function () {
        ...
        Point.prototype.draw = function () {
            this.context.fillStyle = this._color;
            this.context.fillRect(this._x, this._y, 3, 3);
        };
...
function clearSelector() {
    Array.prototype.forEach.call(document.getElementById('options').childNodes,
        function (child) {
...
clearSelector();
var selector = document.getElementById('shape-selection');
selector.addEventListener('change', function () {
    var secondCoordinate = document.getElementById('second-coordinate'),
        thirdCoordinate = document.getElementById('third-coordinate'),
        circleRadius = document.getElementById('circle-radius'),
        widthAndHeight = document.getElementById('width-height');
    clearSelector();
    switch (selector.selectedIndex) {
        case 0:
            ...
            break;
        case 1:
            secondCoordinate.className = 'visible';
            break;
        case 2:
            secondCoordinate.className = 'visible';
            thirdCoordinate.className = 'visible';
            break;
        case 3:
            circleRadius.className = 'visible';
            break;
        case 4:
            widthAndHeight.className = 'visible';
            break
    }
});
